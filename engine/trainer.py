...
class BaseTrainer:
    ...
    def check_resume(self, overrides):
        ...
        # resume = r'E:\PycharmProjects\yolov8\ultralytics-main\runs\detect\train18\weights\last.pt'  #重新加载模型-last.pt（此处是修改的）
        if resume:
            try:
    ...
    def resume_training(self, ckpt):
        # ckpt = torch.load(r'E:\PycharmProjects\yolov8\ultralytics-main\runs\detect\train18\weights\last.pt')    #重新加载模型-last.pt(此处是另外加的)
